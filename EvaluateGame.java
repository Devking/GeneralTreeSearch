...
public class EvaluateGame {
	...
	public static void main(String[] args){
		...
		controllers.GeneralTreeSearch.Agent.filename = parameterPath + "parameters_" + args[1] + ".txt";
		String gameFile = gamesPath + args[2] + ".txt";
		String levelFile = gamesPath + args[2] + "_lvl" + levelIdx + ".txt";
		...
		try {
			PrintWriter file = new PrintWriter(resultPath + "results_" + args[1] + ".csv", "UTF-8");
